...
\begin{DoxyCompactItemize}
\item 
\#define \mbox{\hyperlink{command_8c_a2b1bd24d2eddf8081d8c541e4cc4fd4b}{CMD\+\_\+\+LENGHT}}~50
\item 
\#define \mbox{\hyperlink{command_8c_a5d69aa83ad3929fba7ff0e38924096de}{CMD\+\_\+\+SHORTCUT}}~1
\item 
\#define \mbox{\hyperlink{command_8c_a45427030a543a1fe5b6a6ad24b0415a5}{N\+\_\+\+ARGS}}~4
\item 
\#define \mbox{\hyperlink{command_8c_af1c5fd90d1b8a22169133f549223f2e1}{FIRST\+\_\+\+CHAR}}~0
\item 
\#define \mbox{\hyperlink{command_8c_a9cabeb8b2886fd6bd67fb8cf4ccb2bc2}{STOP\+\_\+\+CHAR}}~1
...
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{command_8c_af3e5f01ffec72a60fbbf0b638299a4d8}{command\+\_\+get\+\_\+argument}} (\mbox{\hyperlink{command_8h_a7d2935971c252377cb0fc1c8545dc2bc}{Command}} \texorpdfstring{$\ast$}{*}command, int position)
...
\mbox{\hyperlink{types_8h_a67a0db04d321a74b7e7fcfd3f1a3f70b}{Status}} \mbox{\hyperlink{command_8c_a17d7801cde894b7960ed953c65798fa7}{command\+\_\+set\+\_\+argument}} (\mbox{\hyperlink{command_8h_a7d2935971c252377cb0fc1c8545dc2bc}{Command}} \texorpdfstring{$\ast$}{*}command, char \texorpdfstring{$\ast$}{*}word, int position)
...
char \texorpdfstring{$\ast$}{*} {\bfseries cmd\+\_\+to\+\_\+str} \mbox{[}\mbox{\hyperlink{command_8h_ae180fe89f0ae48ce5c80ffaa18de9271}{N\+\_\+\+CMD}}\mbox{]}\mbox{[}\mbox{\hyperlink{command_8h_a8d93932dcdc527c13e06b688b68c7ffc}{N\+\_\+\+CMDT}}\mbox{]} = \{\{"{}"{}, "{}No command"{}\}, \{"{}"{}, "{}Unknown"{}\}, \{"{}e"{}, "{}Exit"{}\}, \{"{}m"{}, "{}move"{}\}, \{"{}t"{}, "{}Take"{}\}, \{"{}d"{}, "{}Drop"{}\}, \{"{}a"{}, "{}Attack"{}\}, \{"{}c"{}, "{}Chat"{}\}, \{"{}i"{}, "{}Inspect"{}\}, \{"{}r"{}, "{}recruit"{}\}, \{"{}f"{}, "{}forsake"{}\}, \{"{}u"{}, "{}use"{}\}, \{"{}o"{}, "{}open"{}\}, \{"{}s"{}, "{}save"{}\}, \{"{}co"{}, "{}coop"{}\}, \{"{}un"{}, "{}uncoop"{}\}, \{"{}w"{}, "{}wait"{}\},\{"{}menu"{},"{}menu"{}\}, \{"{}b"{},"{}bag"{}\},\{"{}map"{}, "{}map"{}\},\{"{}help"{},"{}help"{}\}\}
...
{\footnotesize\ttfamily \#define CMD\+\_\+\+LENGHT~50}
...
Command shortcut position. \Hypertarget{command_8c_af1c5fd90d1b8a22169133f549223f2e1}\label{command_8c_af1c5fd90d1b8a22169133f549223f2e1} 
\index{command.c@{command.c}!FIRST\_CHAR@{FIRST\_CHAR}}
\index{FIRST\_CHAR@{FIRST\_CHAR}!command.c@{command.c}}
\doxysubsubsection{\texorpdfstring{FIRST\_CHAR}{FIRST\_CHAR}}
{\footnotesize\ttfamily \#define FIRST\+\_\+\+CHAR~0}

Position number 0 of a string, used to intitialize things \Hypertarget{command_8c_a45427030a543a1fe5b6a6ad24b0415a5}\label{command_8c_a45427030a543a1fe5b6a6ad24b0415a5} 
\index{command.c@{command.c}!N\_ARGS@{N\_ARGS}}
\index{N\_ARGS@{N\_ARGS}!command.c@{command.c}}
\doxysubsubsection{\texorpdfstring{N\_ARGS}{N\_ARGS}}
{\footnotesize\ttfamily \#define N\+\_\+\+ARGS~4}

Number of possible arguments you can input \Hypertarget{command_8c_a9cabeb8b2886fd6bd67fb8cf4ccb2bc2}\label{command_8c_a9cabeb8b2886fd6bd67fb8cf4ccb2bc2} 
\index{command.c@{command.c}!STOP\_CHAR@{STOP\_CHAR}}
\index{STOP\_CHAR@{STOP\_CHAR}!command.c@{command.c}}
\doxysubsubsection{\texorpdfstring{STOP\_CHAR}{STOP\_CHAR}}
{\footnotesize\ttfamily \#define STOP\+\_\+\+CHAR~1}
...
\end{DoxyReturn}
\Hypertarget{command_8c_af3e5f01ffec72a60fbbf0b638299a4d8}\label{command_8c_af3e5f01ffec72a60fbbf0b638299a4d8} 
\index{command.c@{command.c}!command\_get\_argument@{command\_get\_argument}}
\index{command\_get\_argument@{command\_get\_argument}!command.c@{command.c}}
...
OK if everything goes well or ERROR if there was some mistake. 
\end{DoxyReturn}
\Hypertarget{command_8c_a17d7801cde894b7960ed953c65798fa7}\label{command_8c_a17d7801cde894b7960ed953c65798fa7} 
\index{command.c@{command.c}!command\_set\_argument@{command\_set\_argument}}
\index{command\_set\_argument@{command\_set\_argument}!command.c@{command.c}}
