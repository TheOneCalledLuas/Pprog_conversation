 ...
 */
char *cmd_to_str[N_CMD][N_CMDT] = {{"", "No command"}, {"", "Unknown"}, {"e", "Exit"}, {"m", "move"}, {"t", "Take"}, {"d", "Drop"}, {"a", "Attack"}, {"c", "Chat"}, {"i", "Inspect"}, {"r", "recruit"}, {"f", "forsake"}, {"u", "use"}, {"o", "open"}, {"s", "save"}, {"co", "coop"}, {"un", "uncoop"}, {"w", "wait"},{"menu","menu"}};
